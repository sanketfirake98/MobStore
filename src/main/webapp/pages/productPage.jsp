...
<div class="search">
<form action="search"><input type="text" name="name">
<input class="searchButton" type="submit" value="search">
</form>
</div>
<div>
<form action="/Cart/cartButton"><input class="btt" type="submit" value="Go to Cart"></input></form>
</div>
<div style="padding-left: 15px;">
<form action="/Cart/YourOrders"><input class="btt1" type="submit" value="Your Orders"></input></form>

 </div>
</div>
 <div class="table-align">
<table>
<c:forEach items="${lst}" var="element"> 
  <tr>
